          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-2xl shadow-lg text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Excellence in Innovation Award 2024</h3>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Best Local SEO Agency 2024</h3>
                <p className="text-gray-700 mb-4">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Rapid Delivery Champion 2024</h3>
                <p className="text-gray-700 mb-4">
