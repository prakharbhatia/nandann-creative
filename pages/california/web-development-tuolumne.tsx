            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-stone-50 to-gray-50 p-8 rounded-2xl">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Sarah "The Sonora Tech" Chen</h3>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-stone-50 p-8 rounded-2xl">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Mike "The Jamestown Agriculture" Rodriguez</h3>
              ...
              <div className="bg-gradient-to-br from-teal-50 to-stone-50 p-8 rounded-2xl">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Jennifer "The Columbia Manufacturing" Park</h3>
