...
export default function ManhattanPage() {
  ...
  const jsonLd = {
    ...
    "priceRange": "$$",
    "image": "https://www.nandann.com/manhattan/manhattan.jpg"
  };
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:image" content="https://www.nandann.com/manhattan/manhattan.jpg" />
        ...
        <meta name="twitter:image" content="https://www.nandann.com/manhattan/manhattan.jpg" />
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold mb-6" style={{ fontSize: 'clamp(2.25rem, 5vw, 3.75rem)' }}>
            Web Development That Powers Wall Street to Times Square
          </h1>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
          <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-2xl p-8 border border-white border-opacity-20">
            <h2 className="text-4xl font-bold mb-6 text-green-400">
              Manhattan's Premier Web Development Partner
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-6">
                Manhattan's Business Pulse Runs Through Our Code
              </h2>
