...
const inputVideoPath = 'public/colorado/19315353-uhd_3840_2160_30fps.mp4';
const outputDir = 'public/colorado';
const baseName = 'colorado-web-development-nandann-creative';
...
async function main() {
  await optimizeVideo();
  console.log('Colorado video optimization complete!');
}
