...
export default function ManhattanPage() {
  ...
  const jsonLd = {
    ...
    "url": "https://www.nandann.com/web-development-manhattan",
  ...
  return (
    <>
      <Head>
        <title>Web Development Manhattan | Nandann Creative</title>
        ...
        {/* Open Graph tags */}
        <meta property="og:title" content="Web Development Manhattan | Nandann Creative" />
        ...
        <meta property="og:url" content="https://www.nandann.com/web-development-manhattan" />
        <meta property="og:type" content="website" />
        
        {/* Twitter Card tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Web Development Manhattan | Nandann Creative" />
        ...
        <link rel="canonical" href="https://www.nandann.com/web-development-manhattan" />
