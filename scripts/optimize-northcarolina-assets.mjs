...
const inputImagePath = 'public/northcarolina/pexels-nc-farm-bureau-mark-33777991.jpg';
const outputDir = 'public/northcarolina';
const baseName = 'northcarolina-web-development-nandann-creative';
...
async function optimizeImage() {
  ...
  console.log('Image optimization complete for North Carolina.');
}
