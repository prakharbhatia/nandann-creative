...
const inputVideoPath = 'public/virginia/4609533-uhd_3840_2160_24fps.mp4';
const outputDir = 'public/virginia';
const baseName = 'virginia-web-development-nandann-creative';
...
async function main() {
  await optimizeVideo();
  console.log('Virginia video optimization complete!');
}
