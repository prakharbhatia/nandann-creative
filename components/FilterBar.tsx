        ...
        <div className="sticky top-20 z-30 w-full backdrop-blur-xl bg-black/30 border-y border-white/10 py-4 mb-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-4">
                ...
                <div className="flex items-center gap-3 overflow-x-auto pb-2 md:pb-0 custom-scrollbar">
                    <span className="text-sm text-gray-500 whitespace-nowrap">Filter by Tech:</span>
                    <select
                        value={activeTechStack}
                        onChange={(e) => onTechStackChange(e.target.value)}
                        className="bg-white/5 border border-white/10 rounded-lg px-3 py-1.5 text-sm text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                    >
