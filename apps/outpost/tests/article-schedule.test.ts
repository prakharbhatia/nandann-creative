...
import { nextArticleSlot } from "../lib/article-schedule";
import { articleCopy, canonicalArticleUrl } from "../lib/article-input";
...
describe("live website feed contract", () => {
  it("sorts articles oldest first with stable tie-breaking", async () => {
    const { parseArticleFeed } = await import("../lib/article-feed");
