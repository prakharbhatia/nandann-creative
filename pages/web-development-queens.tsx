...
export default function QueensPage() {
  ...
  const jsonLd = {
    ...
    "url": "https://www.nandann.com/web-development-queens",
  ...
  return (
    <>
      <Head>
        <title>Web Development Queens | Nandann Creative</title>
        ...
        {/* Open Graph tags */}
        <meta property="og:title" content="Web Development Queens | Nandann Creative" />
        ...
        <meta property="og:url" content="https://www.nandann.com/web-development-queens" />
        <meta property="og:type" content="website" />
        
        {/* Twitter Card tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Web Development Queens | Nandann Creative" />
        ...
        <link rel="canonical" href="https://www.nandann.com/web-development-queens" />
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <video
            ...
            poster="/queens/queens-web-development-nandann-creative-poster.webp"
          >
            <source src="/queens/queens-web-development-nandann-creative-hd.webm" type="video/webm" />
            <source src="/queens/queens-web-development-nandann-creative-hd.mp4" type="video/mp4" />
          </video>
      ...
      <section className="relative py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="/queens/queens-web-development-nandann-creative-lg.webp"
