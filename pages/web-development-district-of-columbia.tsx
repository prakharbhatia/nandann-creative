            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-blue-50 to-green-50 p-8 rounded-2xl">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Mike "The Downtown Powerhouse" Johnson</h3>
              ...
              <div className="bg-gradient-to-br from-green-50 to-blue-50 p-8 rounded-2xl">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Sarah "The Georgetown Strategist" Williams</h3>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-blue-50 p-8 rounded-2xl">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Tom "The Capitol Hill Dynamo" Thompson</h3>
