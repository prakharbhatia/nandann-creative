...
const inputImagePath = 'public/newjersey/pexels-jdominici-286076.jpg';
const outputDir = 'public/newjersey';
const baseName = 'newjersey-web-development-nandann-creative';
...
async function optimizeImage() {
  ...
  console.log('Image optimization complete for New Jersey.');
}
