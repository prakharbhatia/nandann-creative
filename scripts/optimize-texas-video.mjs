...
console.log('🎬 Starting Texas video optimization...\n');
...
const videoSrc = '3398074-hd_1920_1080_30fps.mp4';
const videoName = 'texas-web-development-nandann-creative';
const resolutions = [
...
console.log('\n🎉 Texas video optimization complete!\n'); 