...
export default function NewYorkPage() {
  ...
  const jsonLd = {
    ...
    "url": "https://www.nandann.com/new-york",
  ...
  return (
    <>
      <Head>
        <title>Web Development Agency in New York | Nandann Creative - Custom Websites & Local SEO</title>
        <meta name="description" content="Premier web development agency in New York. Custom websites, rapid delivery, local SEO optimization, and ongoing support for NYC businesses. Transform your digital presence today." />
        ...
        <meta property="og:url" content="https://www.nandann.com/new-york" />
        ...
        <meta property="twitter:url" content="https://www.nandann.com/new-york" />
        ...
        <link rel="canonical" href="https://www.nandann.com/new-york" />
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 transform hover:scale-105">
                    Get Your Free Quote
                  </button>
              ...
              <div className="relative">
                <picture>
                  <source
                    srcSet="/newyork/pexels-pixabay-40142-xl.webp"
                    media="(min-width: 1280px)"
                  />
                  <source
                    srcSet="/newyork/pexels-pixabay-40142-lg.webp"
                    media="(min-width: 1024px)"
                  />
                  <source
                    srcSet="/newyork/pexels-pixabay-40142-md.webp"
