...
import { Account, Post, Platform, platformName } from "@/lib/types";
...
import { nextDailySlot } from "@/lib/article-schedule";
...
export default function Workspace() {
  ...
  useEffect(() => {
    ...
    if (q.size) history.replaceState({}, "", "/");
  }, []);
  useEffect(() => {
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (demo || !config[p === "x" ? "x" : "linkedin"]) {
                        ...
                        setView("settings");
                      } else location.href = "/api/oauth/" + p;
                    }}
                  >
                    <Link2 size={16} />
                  ...
                  {p !== "x" && (
                    <button
                      ...
                      onClick={() => {
                        ...
                        location.href = "/api/oauth/" + p + "?comments=1";
                      }}
                    >
