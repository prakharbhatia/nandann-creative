...
const inputImagePath = 'public/arizona/pexels-photospublic-33041.jpg';
const outputDir = 'public/arizona';
const baseName = 'arizona-web-development-nandann-creative';
...
async function optimizeImage() {
  ...
  console.log('Image optimization complete for Arizona.');
}
